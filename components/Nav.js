...
export default function Nav({ show }) {
  ...
  const router = useRouter(); // This hook is used to acquire the info about url path that we are in.
  ...
  return (
    <aside
      className={
        ...
        " top-0 text-gray-500 p-4 fixed w-full bg-gray-200 h-full -left-full md:static md:w-auto transition-all"
      }
    >
